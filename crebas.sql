...
/* Created on:     26/09/2023 09:32:07                          */
/*==============================================================*/
...
drop index if exists PENJUALAN.RELATIONSHIP_3_FK;
...
drop index if exists PRODUK.RELATIONSHIP_1_FK;
...
/*==============================================================*/
create index RELATIONSHIP_3_FK on PENJUALAN (
PEM_ID ASC
);
...
/*==============================================================*/
create index RELATIONSHIP_1_FK on PRODUK (
JEN_ID ASC
);
...
(
   ...
   constraint PK_STOK primary key clustered (TOK_ID, PRO_ID)
);

/*==============================================================*/
/* Index: STOK_PK                                               */
/*==============================================================*/
create unique clustered index STOK_PK on STOK (
TOK_ID ASC,
PRO_ID ASC
);
...
alter table PRODUK
   add constraint FK_PRODUK_RELATIONS_STOK foreign key (TOK_ID, PRO_ID)
      references STOK (TOK_ID, PRO_ID)
      on update restrict
      on delete restrict;
